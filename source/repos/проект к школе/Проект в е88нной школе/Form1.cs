...
namespace Проект_к_школе
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void list_of_questions_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (list_of_lessons.SelectedItem != null && list_of_questions.Nodes[Selected_index] != null)
            {
                ...
                if (Selected_index == 24) Next.Text = "Закончить";    
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            if (list_of_questions.SelectedNode != null)
            {
                ...
                if (list_of_questions.SelectedNode.Index == 24)
                {
                    ...
                    {
                        //Вставить проверку на колл-во пройденых тестов
        ...
        {
           // GlobalColor = ListThems[1].SecoundaryColor;
            //SecondaryColor = ListThems[1].GlobalColor;
           // LabelColor = Color.White;
          //  ButtonColor = ListThems[1].ButtonColor;
           // Personalize();
        }
    }
}
